...
class Character(AnimatedSprite):
	def __init__(self, pos, damage, range, *groups):
		super().__init__(groups)
	...
	def update(self, dt):
		...
		self.health_bar.update_(self.health, self.rect.midtop)


class Projectile(pg.sprite.Sprite):
	def __init__(self, pos, vel, damage, range, *groups):
		super().__init__(groups)
...
class AnimatedProjectile(AnimatedSprite):
	def __init__(self, pos, vel, damage, range, *groups):
		super().__init__(groups)
